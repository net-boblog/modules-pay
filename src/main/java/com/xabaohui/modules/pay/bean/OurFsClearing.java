...
/**
 * OurFsClearing entity. @author MyEclipse Persistence Tools
 */

public class OurFsClearing implements java.io.Serializable {
	...
	/** default constructor */
	public OurFsClearing() {
	}

	/** full constructor */
	public OurFsClearing(Integer instructionId, Integer protocolId,
