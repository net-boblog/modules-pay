...
<body>
    ...
    <div class="content">
        <form action="/Zis-Pay/pay/" class="alipayform" method="POST" target="_blank">
            ...
            <div class="element">
                ...
                <br>
                <div class="mark">注意：userID应该又上个界面传入，这里先填</div>
            </div>
            ...
            <div class="element">
                ...
                <br>
                <div class="mark">注意：支付金额(rechargeMoney)，必填(格式如：1.00,请精确到分)</div>
            </div>
            <div class="element">
